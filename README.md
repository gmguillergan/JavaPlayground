...
|---|---|---|---|
| **Lesson 2.1** | Applying Basics of Java Programming (Syntax, Variables, Scanner, JVM/JDK/JRE) | [`GuillerganOperatorICT1201.java`](Quarter-2/2Q_Guillergan_ICT%201/src/Lesson2_1/GuillerganOperatorICT1201.java) (Worksheet 2.1) [`Guillergan_JavaBasics_ICT1201.java`](Quarter-2/2Q_Guillergan_ICT%201/src/Lesson2_1/Guillergan_JavaBasics_ICT1201.java) (Worksheet 2.2 pt. 1) [`Guillergan_Instantiation_ICT1201.java`](Quarter-2/2Q_Guillergan_ICT%201/src/Lesson2_1/Guillergan_Instantiation_ICT1201.java) (Worksheet 2.2 pt. 2) | Completed |
| **Lesson 2.2** | Fundamentals of OOP (Classes, Objects, Methods, Constructors, Attributes) | [`Guillergan_HOA3JavaOOP.java`](Quarter-2/2Q_Guillergan_ICT%201/src/Lesson2_2/Guillergan_HOA3JavaOOP.java) (Worksheet 2.3) | Completed |
...
#### 1. `GuillerganOperatorICT1201.java` (Worksheet 2.1)
...
#### 2. `Guillergan_Instantiation_ICT1201.java` & `Guillergan_JavaBasics_ICT1201.java` (Worksheet 2.2)
...
#### 3. `Guillergan_HOA3JavaOOP.java` (Worksheet 2.3)
- **Lecture Focus:** Lesson 2.2	Basic OOP Concepts (specifically Method Overloading)
- **Implementation:** Displays various versions of the `exam()` method with distinct parameters and data types such as _int, String, float, and double_.
...
javac Lesson2_1/GuillerganOperatorICT1201.java
java Lesson2_1/GuillerganOperatorICT1201

# Worksheet 2.2 (Java Basics)
javac Lesson2_1/Guillergan_JavaBasics_ICT1201.java
java Lesson2_1/Guillergan_JavaBasics_ICT1201
```
